...
"""
需要先安装tensorrt. 先去nvidia下载,再安装.
https://github.com/open-mmlab/mmcv/blob/master/docs/en/deployment/tensorrt_plugin.md

python tools/deployment/onnx2tensorrt.py /mnt/zy_data/detection/face_detection/out_2/latest.onnx  \
--trt-file /mnt/zy_data/detection/face_detection/out_2/latest.trt --input-img demo/demo.jpg --shape 400 600 \
--mean 123.675 116.28 103.53 --std 58.395 57.12 57.375 --show --verify
