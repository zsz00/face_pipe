...
def parse_normalize_cfg(test_pipeline):
    ...
    norm_config = norm_config_li[0] if len(norm_config_li) == 1 else dict(mean=0.0, std=1.0)
    return norm_config
...
python tools/deployment/pytorch2onnx.py configs/yolo/yolov3_d53_mstrain-608_273e_face_1.py \
/mnt/zy_data/detection/face_detection/out_2/latest.pth --input-img=demo/test_data/4.jpg \
--output-file=/mnt/zy_data/detection/face_detection/out_2/latest.onnx
235M  latest.onnx

python tools/deployment/pytorch2onnx.py configs/yolox/yolox_s_8x8_300e_face_1.py \
/mnt/zy_data/detection/face_detection/out_3/latest.pth --input-img=demo/test_data/4.jpg \
--output-file=/mnt/zy_data/detection/face_detection/out_3/latest.onnx
